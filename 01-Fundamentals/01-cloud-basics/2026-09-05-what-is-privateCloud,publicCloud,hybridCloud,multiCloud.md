...
- **Public cloud** = someone else's infrastructure that I rent.
- **Private cloud** = infrastructure dedicated to my organization.
- **Hybrid cloud** = private + public environments working together.
...
1. Run a simple telemetry generator locally that produces machine data.
2. Send the data through a secure connection to Azure.
3. Ingest it using Azure IoT Hub.
4. Store raw data in Azure Data Lake Storage Gen2.
5. Process the data using an Azure compute service.
6. Expose processed data through a dashboard.
7. Document which components are private/on-premises and which are public cloud.
